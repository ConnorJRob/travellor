...
describe('Traveller', function() {
  ...
  it('should be able to get the journeys transport methods (i added this myself)', function() {
    const expected = [
      journey1.transport,
      journey2.transport,
      journey3.transport,
    ...
    assert.deepStrictEqual(traveller.getJourneyTransportTypes(), expected);
  });
